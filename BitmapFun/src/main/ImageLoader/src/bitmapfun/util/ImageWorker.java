...
public abstract class ImageWorker {
     ...
     */
    public void loadImage(Object data, View imageView) {
        if (data == null) {
            return;
        }
        ...
        if (value != null) {
            ...
            if(imageView instanceof ImageView)
                ((ImageView) imageView).setImageDrawable(value);
            else imageView.setBackground(value);
    ...
    public BitmapDrawable getBitMapDrawable(Object data, ImageView imageView) {
     ...
     */
    public void addImageCache(android.support.v4.app.FragmentManager fragmentManager, ImageCache.ImageCacheParams cacheParams) {
